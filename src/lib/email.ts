      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(135deg, #10b981, #3b82f6); padding: 20px; border-radius: 10px; margin-bottom: 20px;">
            ...
            <p style="color: white; margin: 10px 0 0 0;">Thank you for your purchase, ${orderData.customerName}!</p>
          </div>
          
          <div style="background: #f0fdf4; padding: 20px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #10b981;">
            <h2 style="color: #166534; margin-top: 0;">Your Order Details</h2>
            <p><strong>Order Number:</strong> <span style="font-family: monospace; background: #dcfce7; padding: 2px 6px; border-radius: 4px;">${orderData.orderNumber}</span></p>
            <p><strong>Total Amount:</strong> ৳${orderData.totalAmount}</p>
            <p><strong>Payment Method:</strong> ${orderData.paymentMethod}</p>
          </div>

          <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            <h2 style="color: #1e293b; margin-top: 0;">Educational Materials Ordered</h2>
            <div style="font-family: monospace; white-space: pre-line; background: white; padding: 15px; border-radius: 5px; border-left: 4px solid #3b82f6;">
${itemsList}
            </div>
          </div>
          ...
          <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #f59e0b;">
            <h2 style="color: #92400e; margin-top: 0;">📋 What's Next?</h2>
            <ul style="color: #92400e; margin: 0; padding-left: 20px;">
              <li>For digital materials: Download links will be sent within 24 hours</li>
              <li>For physical delivery: Your materials will be shipped within 2-3 business days</li>
          ...
          <div style="background: #f8fafc; padding: 20px; border-radius: 8px;">
            <h2 style="color: #1e293b; margin-top: 0;">Order Summary</h2>
            <p><strong>Subtotal:</strong> ৳${orderData.subtotal}</p>
            <p><strong>Delivery:</strong> ${orderData.deliveryCharge === 0 ? 'Free' : `৳${orderData.deliveryCharge}`}</p>
            <p style="font-size: 18px; color: #10b981;"><strong>Total: ৳${orderData.totalAmount}</strong></p>
          </div>

          <div style="text-align: center; margin-top: 30px; padding: 20px; background: #e0f2fe; border-radius: 8px;">
            <p style="margin: 0; color: #0369a1;">
              📚 Thank you for choosing EduMaterials for your educational needs!
            </p>
